 ...
 * 3x4 matrix.
 */
final class Matrix3x4 extends DefaultMatrix {
  ...
  /**
   * Construct a new Matrix3x4 instance.
  ...
  /**
   * Add a Matrix3x4 this this Matrix3x4.
   * @param other The other matrix
   * @return The resulting matrix
   */
  public Matrix3x4 add(Matrix3x4 other) {
   ...
   * @return The resulting matrix
   */
  public Matrix3x4 subtract(Matrix3x4 other) {
    return new Matrix3x4(
      this.r0c0 - other.r0c0,
      this.r0c1 - other.r0c1,
      this.r0c2 - other.r0c2,
  ...
  public Matrix subtract(Matrix other) {
    if (other instanceof Matrix3x4) {
      return subtract((Matrix3x4) other);
    } else {
  ...
  /**
   * Multiply this Matrix3x4 with a Matrix4x1.
   * @param other The other matrix
   * @return The resulting matrix
   */
  Matrix3x1 multiply(Matrix4x1 other) {
  ...
  /**
   * Multiply this Matrix3x4 with a Matrix4x2.
   * @param other The other matrix
   * @return The resulting matrix
   */
  Matrix3x2 multiply(Matrix4x2 other) {
  ...
  /**
   * Multiply this Matrix3x4 with a Matrix4x3.
   * @param other The other matrix
   * @return The resulting matrix
   */
  Matrix3x3 multiply(Matrix4x3 other) {
  ...
  /**
   * Multiply this Matrix3x4 with a Matrix4x4.
   * @param other The other matrix
   * @return The resulting matrix
   */
  Matrix3x4 multiply(Matrix4x4 other) {
    return new Matrix3x4(
      this.r0c0 * other.r0c0 +
      this.r0c1 * other.r1c0 +
      this.r0c2 * other.r2c0 +
  ...
  /**
   * Multiply this Matrix3x4 with a Matrix4x5.
   * @param other The other matrix
   * @return The resulting matrix
   */
  Matrix3x5 multiply(Matrix4x5 other) {
   ...
   */
  @Override
  public Matrix3x4 multiply(double multiplicand) {
    return new Matrix3x4(
