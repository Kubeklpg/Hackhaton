 ...
 * 4x5 matrix.
 */
final class Matrix4x5 extends DefaultMatrix {
  ...
  /**
   * Add a Matrix4x5 this this Matrix4x5.
   * @param other The other matrix
   * @return The resulting matrix
   */
  public Matrix4x5 add(Matrix4x5 other) {
   ...
   * @return The resulting matrix
   */
  public Matrix4x5 subtract(Matrix4x5 other) {
    return new Matrix4x5(
      this.r0c0 - other.r0c0,
      this.r0c1 - other.r0c1,
      this.r0c2 - other.r0c2,
  ...
  public Matrix subtract(Matrix other) {
    if (other instanceof Matrix4x5) {
      return subtract((Matrix4x5) other);
    } else {
  ...
  /**
   * Multiply this Matrix4x5 with a Matrix5x1.
   * @param other The other matrix
   * @return The resulting matrix
   */
  Matrix4x1 multiply(Matrix5x1 other) {
  ...
  /**
   * Multiply this Matrix4x5 with a Matrix5x2.
   * @param other The other matrix
   * @return The resulting matrix
   */
  Matrix4x2 multiply(Matrix5x2 other) {
  ...
  /**
   * Multiply this Matrix4x5 with a Matrix5x3.
   * @param other The other matrix
   * @return The resulting matrix
   */
  Matrix4x3 multiply(Matrix5x3 other) {
  ...
  /**
   * Multiply this Matrix4x5 with a Matrix5x4.
   * @param other The other matrix
   * @return The resulting matrix
   */
  Matrix4x4 multiply(Matrix5x4 other) {
  ...
  /**
   * Multiply this Matrix4x5 with a Matrix5x5.
   * @param other The other matrix
   * @return The resulting matrix
   */
  Matrix4x5 multiply(Matrix5x5 other) {
    return new Matrix4x5(
      this.r0c0 * other.r0c0 +
      this.r0c1 * other.r1c0 +
      this.r0c2 * other.r2c0 +
   ...
   */
  @Override
  public Matrix4x5 multiply(double multiplicand) {
    return new Matrix4x5(
