 ...
 * 3x5 matrix.
 */
final class Matrix3x5 extends DefaultMatrix {
  ...
  /**
   * Add a Matrix3x5 this this Matrix3x5.
   * @param other The other matrix
   * @return The resulting matrix
   */
  public Matrix3x5 add(Matrix3x5 other) {
   ...
   * @return The resulting matrix
   */
  public Matrix3x5 subtract(Matrix3x5 other) {
    return new Matrix3x5(
      this.r0c0 - other.r0c0,
      this.r0c1 - other.r0c1,
      this.r0c2 - other.r0c2,
  ...
  public Matrix subtract(Matrix other) {
    if (other instanceof Matrix3x5) {
      return subtract((Matrix3x5) other);
    } else {
  ...
  /**
   * Multiply this Matrix3x5 with a Matrix5x1.
   * @param other The other matrix
   * @return The resulting matrix
   */
  Matrix3x1 multiply(Matrix5x1 other) {
  ...
  /**
   * Multiply this Matrix3x5 with a Matrix5x2.
   * @param other The other matrix
   * @return The resulting matrix
   */
  Matrix3x2 multiply(Matrix5x2 other) {
  ...
  /**
   * Multiply this Matrix3x5 with a Matrix5x3.
   * @param other The other matrix
   * @return The resulting matrix
   */
  Matrix3x3 multiply(Matrix5x3 other) {
  ...
  /**
   * Multiply this Matrix3x5 with a Matrix5x4.
   * @param other The other matrix
   * @return The resulting matrix
   */
  Matrix3x4 multiply(Matrix5x4 other) {
  ...
  /**
   * Multiply this Matrix3x5 with a Matrix5x5.
   * @param other The other matrix
   * @return The resulting matrix
   */
  Matrix3x5 multiply(Matrix5x5 other) {
    return new Matrix3x5(
      this.r0c0 * other.r0c0 +
      this.r0c1 * other.r1c0 +
      this.r0c2 * other.r2c0 +
   ...
   */
  @Override
  public Matrix3x5 multiply(double multiplicand) {
    return new Matrix3x5(
